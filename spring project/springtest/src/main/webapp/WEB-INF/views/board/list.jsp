...
<ul class="pagination justify-content-center">
	<li class="page-item <c:if test='${!pm.prev}'>disabled</c:if>">
		<a href="<c:url value='/board/ilst?page=${pm.startPage-1}&search=${pm.cri.search}&type=${pm.cri.type}'></c:url>" class="page-link">이전</a>
	</li>
	...
	<li class="page-item <c:if test='${!pm.next}'>disabled</c:if>">
		<a href="<c:url value='/board/ilst?page=${pm.endPage+1}&search=${pm.cri.search}&type=${pm.cri.type}'></c:url>" class="page-link">다음</a>
	</li>
</ul>
