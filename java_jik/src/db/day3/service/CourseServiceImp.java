...
public class CourseServiceImp implements CourseService{
	...
	public void insertLecture() {
		...
		LectureVO lec = new LectureVO(0, le_name, le_schedule, le_point, 
				le_class, le_year, le_term, le_pr_num);
		courseDao.insertLecture(lec);
	}
	...
	public void updateLecture() {
		...
		System.out.print("지도교수번호> ");
		String le_pr_num = scan.nextLine();
		LectureVO lec = new LectureVO(le_num, le_name, le_schedule, le_point, 
				le_class, le_year, le_term, le_pr_num);
		courseDao.updateLecture(lec);		
	}
