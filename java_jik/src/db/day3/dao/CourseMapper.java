...
public class CourseMapper implements CourseDAO{
	...
	public void insertLecture(LectureVO lec) {
		...
		try {
			...
			dbConnector.pstmt.setString(1, lec.getLe_name());
			dbConnector.pstmt.setString(2, lec.getLe_schedule());
			dbConnector.pstmt.setInt(3, lec.getLe_point());
			dbConnector.pstmt.setInt(4, lec.getLe_class());
			dbConnector.pstmt.setInt(5, lec.getLe_year());
			dbConnector.pstmt.setString(6, lec.getLe_term());
			dbConnector.pstmt.setString(7, lec.getLe_pr_num());
	...
	public void updateLecture(LectureVO lec) {
		String sql = "update lecture set le_name = ?, le_schedule = ?, le_point = ?, "
				+ "le_class = ?, le_year = ?, le_term = ?, le_pr_num = ? where le_num = ?";
		try {
			dbConnector.pstmt = dbConnector.con.prepareStatement(sql);
			dbConnector.pstmt.setString(1, lec.getLe_name());
			dbConnector.pstmt.setString(2, lec.getLe_schedule());
			...
			dbConnector.pstmt.setString(6, lec.getLe_term());
			dbConnector.pstmt.setString(7, lec.getLe_pr_num());
			dbConnector.pstmt.setInt(8, lec.getLe_num());
			int count = dbConnector.pstmt.executeUpdate();
			if(count == 0)
	...
	public LectureVO selectLectureByName(String le_name, int le_class, int le_year, 
			String le_term) {
