...
//		}
	...
	private void updateStudent() {
		...
		StudentVO std = studentDao.selectStudent(st_num); //학번으로 학생을 찾음
		if(std==null) { //리턴한 학생이 없음 = 학번을 잘못 입력함
		...
		if(studentDao.updateStudent(std) != 0) { //전체바꾸는 메소드 만들어두고 활용도 높이려고 분리
